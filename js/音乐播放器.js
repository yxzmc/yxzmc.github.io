document.addEventListener('DOMContentLoaded', function() {
    ...
    var songs = [
        ...
        { title: 'アイヲウタエ-春奈露娜', src: '音乐/アイヲウタエ-春奈露娜_音频音频.mp4' },
        { title: 'オレンジミント-斧乃木余接', src: 'オレンジミント-斧乃木余接_音频.mp4' },
        ...
        { title: '白金ディスコ', src: '白金ディスコ-阿良良木月火_音频.mp4' },
        ...
        { title: '花痕 -shirushi- -河野万里奈', src: '花痕 -shirushi- -河野万里奈_音频.mp4' },
